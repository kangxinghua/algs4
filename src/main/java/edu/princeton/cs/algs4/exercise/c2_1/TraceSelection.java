/*************************************************************************
 * Compilation: javac TraceSelection.java Execution: java TraceSelection input
 *
 * Selection sort the sequence of strings specified on the command-line and show
 * the detailed trace.
 *
