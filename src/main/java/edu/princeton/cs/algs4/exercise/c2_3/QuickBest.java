...
/*************************************************************************
 * Compilation: javac QuickBest.java Execution: java QuickBest N
 * 
 * Generate a best-case input of size N for standard quicksort.
 *
 * % java QuickBest 3 BAC
 *
 * % java QuickBest 7 DACBFEG
 *
 * % java QuickBest 15 HACBFEGDLIKJNMO
 *
 *************************************************************************/

public class QuickBest {

	// postcondition: a[lo..hi] is best-case input for quicksorting that
	// subarray
