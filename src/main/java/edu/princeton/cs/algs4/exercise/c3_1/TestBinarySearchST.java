...
/*************************************************************************
 * Compilation: javac TestBinarySearchST.java Execution: java -ea
 * TestBinarySearchST Dependencies: java BinarySearchST.java
 * 
...
public class TestBinarySearchST {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < from.length; i++) {
			StdOut.printf("%s-%s (%2d) : ", from[i], to[i],
					st.size(from[i], to[i]));
