package edu.princeton.cs.algs4.exercise.c3_2;
...
/*************************************************************************
 * Compilation: javac NonrecursiveBST.java Execution: java NonrecursiveBST <
 * input.txt
 *
 * A symbol table implemented with a binary search tree using iteration instead
 * of recursion for put(), get(), and keys().
 * 
 * % more tinyST.txt S E A R C H E X A M P L E
 * 
 * % java NonrecursiveBST < tinyST.txt A 8 C 4 E 12 H 5 L 11 M 9 P 10 R 3 S 0 X
 * 7
 *
 *************************************************************************/
